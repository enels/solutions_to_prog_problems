...
if __name__ == "__main__":
    ...
    wallet.append(CreditCard("Newton Uwaifo", "Unity Bank", "0033670233", 7500, 100))
    wallet.append(CreditCard("Enoma Wasy", "Unity Bank", "0033670233", 1000, 300))
    wallet.append(CreditCard("Osas Isiho", "Unity Bank", "0033670233", 3000, 1000))
